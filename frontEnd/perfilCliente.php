...
$estrutura = tabelaRequisicoesCliente();
 ?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
        ...
        <div class="container-fluid">
            <div>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-success text-white m-2" href="pedidoCliente.php">Fazer um pedido</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-success text-white m-2 active" href="#atualiza_contato">Atualizar contato</a>
                    </li>
                    <li class="nav-item">
        ...
        <form action="../backend/atualizaUsuario.php" method="post">
            <div class="container rounded bg-white mt-5 mb-5">
                <div class="row">
                        ...
                        <div class="col-md-6 border-right" id="atualiza_contato">
                            <div class="row">
                                ...
                                <div>
                                    <button type="button" class="col-md-7 col-lg-12 btn btn-outline-success btn-lg my-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        atualizar contato
                                    </button>
