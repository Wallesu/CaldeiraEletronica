<?php
    ...
    $estrutura = tabelaRequisicoesAdm();
    $estrutura2 = tabelaRequisicoesAdm2();
 ?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
                        ...
                        <div class="col-md-6 border-right" id="atualiza_contato">
                            <div class="row">
                                ...
                                <div class="reqContainer">
                                    ...
                                    <table id="tabelaRequisicoes2" class="display mt-5" style="width:100%">
                                        <thead class="bg-success">
                                            <tr>
                                                <th>Nome</th>
                                                <th>CPF</th>
...
<script src="js/tabelaDados2.js"></script>
</html>
